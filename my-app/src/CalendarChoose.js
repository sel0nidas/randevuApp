...
export default function CalendarChoose() {
    ...
    return (
        <div className="flex row px-7 calendarMainBloque justify-center items-center">
            <div className="p-10 rounded-xl" style={{height: '50vh'}}>
            ...
            <div className="mt-3 w-100 px-7 overflow-auto  h-80">
                ...
                {userList.map((evt)=>(
                    <div className="col-md-12 row flex justify-center py-3 cursor-pointer border-2 bg-gray-300 itemOnListofUsers" key={evt.id} onClick={()=>{localStorage.setItem("appointmentGiver", evt.id); navigate(`/calendar?receiver=${evt.id}`)}}>
