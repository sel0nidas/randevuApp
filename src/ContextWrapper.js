...
export default function ContextWrapper(props){ 
    ...
    function weekAndDay(date2) {
        var date = new Date("2023-09-06")
    ...
    console.log("flaired", dayjs().week(), new Date("2023-09-06"), weekAndDay(new Date()))
    ...
    const [showUserInfo, setShowUserInfo] = useState(1);
